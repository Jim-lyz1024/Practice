            ...
            <div class="row">
                ...
                <div class="col-md-8" >
                    ...
                    <ul class="nav nav-pills nav-justified btn-group about"  id="newstype" role="group" aria-label="">
                        <li  class="btn btn-default" onclick="window.location.href='http://114.55.145.59:80/rctms/home_detail/register.jsp'">企业入驻</li>
                        <li  class="btn btn-default" onclick="window.location.href='http://114.55.145.59:80/rctms/home_detail/vipres.jsp'">成为VIP企业</li>
                    </ul>
                </div>
