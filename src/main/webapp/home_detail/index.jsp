...
<div class="container" id="platform">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p id="aboutCon"></p>
            <button type="button" onclick="javascript:location.href='about.jsp'">查看详情</button></div>
    </div>
</div>
<div class="position">
    <!--服务内容-->
...
<div class="container tabs" id="partner">
    ...
    <div class="partner-wrap">
        <div class="row partner tab text" id="div_com1" style="display: block;">
            <div class="col-md-3 col-sm-6 col-xs-6"><img src="../homeImages/93693AD0-A59B-4248-B6B7-B8E517643442_A.png" class="img-responsive"><h5 title="对外贸易有限公司   ">对外贸易有限公司   </h5></div></div>
        <div class="row partner tab" id="div_com2" style="display: none;">
            <div class="col-md-3 col-sm-6 col-xs-6"><img src="../homeImages/2B168453-1C45-4941-88C6-880E03CE567B_260.jpg" class="img-responsive"><h5 title="乌里扬诺夫斯克航空技术与生产组织研究所">乌里扬诺夫斯克航空技术与...</h5></div><div class="col-md-3 col-sm-6 col-xs-6"><img src="../homeImages/F42D43F0-D62E-4A1D-B942-B2A5A94ABA0F_2021-02-27_093922.png" class="img-responsive"><h5 title="乌里扬诺夫斯克发动机制造厂 Ульяновский моторный завод (УМЗ)">乌里扬诺夫斯克发动机制造...</h5></div></div>
        <div class="row partner tab" id="div_com3" style="display: none;">
        </div>
    </div>
</div>
<!--底部-->
            ...
            success:function(result){
                if(result.message=="success"){
                    $.each(result.obj,function(key,order){
                        ...
                        str+="<div>";
                        str+="<img src="+order.img1+"'../homeImages'  class='img-responsive' >";
                        ...
                        str+="<button onclick=\"window.location.href='purchase.jsp'\">国际采购订单</button>";
                        str+=" </div>";
                        str+=" </div>";
                        $("#gjcgdd").append(str);
                    });
            ...
            success:function(result){
                if(result.message=="success"){
                    $.each(result.obj,function(key,order){
                        ...
                        str+="<p>"+order.orderNameen+"</p>";
                        str+="<button onclick=\"window.location.href='supply.jsp'\">国际供应订单</button>";
                        str+=" </div>";
                        str+=" </div>";
                        $("#gjgydd").append(str);
                    });
