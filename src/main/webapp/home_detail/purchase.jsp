...
<div class="containerbox">
    ...
    <div class="menu"> 当前位置：<a href="../index.jsp">首页</a> >> <a href="purchase.jsp">国际采购</a> <span id="businessName"></span></div>
</div>
<!--国际采购订单-->
<div class="container" >
    <div class="row">
        <div  class="col-md-9" id="purchase">
            <div class="row purchase-title" >
                <div class="col-md-12 ">
                    <h2 class="div-title"> 国际采购 <span>IMPORT SUPPLY</span></h2>
                </div>
            </div>
            <div class="order" id="orderlist" >
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <h4><a href="http://114.55.145.59:80/rctms/home_detail/purchase_details.jsp">国际采购订单中文名称</a></h4>
                            ...
                            success:function(result){
                                if(result.message=="success"){
                                    ...
                                    $.each(result.obj,function(key,business){
                                        str+="<li><a href='purchase.jsp?businessid="+business.id+"&businessName="+business.businessName+"'>"+business.businessName+"</a></li>";
                                    });
                            ...
                            success:function(result){
                                if(result.message=="success"){
                                    $.each(result.obj,function(key,order){
                                        ...
                                        str+="<h4 onclick=\"window.location.href='purchase_details.jsp?orderid="+order.orderid+"'\">"+order.orderNamech+"</h4>";
...
<script>
    ...
    function getRowHtml(order){
        ...
        var strRow  ='<div class="row">'
            ...
            +'    </div>'
            +'    <div class="col-sm-8">'
            +'        <h4><a href="http://114.55.145.59:80/rctms/home_detail/purchase_details.jsp?orderid='+order.orderid+'">'
    ...
    function displaySupplyList(pageNum){
        ...
        var url="home/homePurchaseOrderList"+params;
        //alert(url);
        var method="GET";
        var id = "#orderlist";
